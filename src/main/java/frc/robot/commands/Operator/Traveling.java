...
import frc.robot.commands.Intake.Travel;
...
public class Traveling extends ParallelCommandGroup {
  /** Creates a new Traveling. */
  Elevator elevator;
  Intake intake;
  public Traveling(Elevator elevator, Intake intake) {
