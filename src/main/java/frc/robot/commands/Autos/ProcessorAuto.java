...
import frc.robot.commands.Drivetrain.ProcessorDriveAuto;
...
public class ProcessorAuto extends SequentialCommandGroup {
  /** Creates a new CoralAuto. */
  Drivetrain drivetrain;
  Intake intake;
  Elevator elevator;
  public ProcessorAuto(Drivetrain drivetrain, Intake intake, Elevator elevator) {
    ...
    addCommands(
      ...
      Commands.race(
        new WaitCommand(2.5),
        new ProcessorDriveAuto(drivetrain, 0, 0.05, 0, 1)
      )
    );
  }
}
